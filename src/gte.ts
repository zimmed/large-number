 ...
 */
export default function gte(ln1: LargeNumber, ln2: LargeNumber): boolean {
  ...
  return (
    ln2.fractionBuckets.length === ln1.fractionBuckets.length ||
    (ln2.fractionBuckets.length > ln1.fractionBuckets.length && ln1.negative)
  );
}
